...
1. 고객이 메뉴를 선택하여 주문한다
1. 고객이 결제한다
1. ~~주문이 되면 주문 내역이 입점상점주인에게 전달된다~~주문이 되면 주문 내역이 지점에 전달된다
1. ~~상점주인이 확인하여 요리해서 배달 출발한다~~지점에서 확인하여 요리해서 배달 출발한다
1. ~~고객이 주문을 취소할 수 있다~~요리가 시작되지 않았으면 고객은 주문을 취소할 수 있다
1. ~~주문이 취소되면 배달이 취소된다~~주문이 취소되면 지점의 요리 대상 목록에서 삭제된다
...
![image](https://user-images.githubusercontent.com/69283682/97388101-bc10e500-191a-11eb-92a8-35ffd5f788f9.png)
